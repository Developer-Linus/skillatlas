...
function DashboardPage() {
  ...
  return __jacJsx("div", {"className": "min-h-screen bg-gray-50 font-sans p-6", "style": {"backgroundImage": "linear-gradient(rgba(255,255,255,0.75), rgba(255,255,255,0.78)), url(/static/assets/dashboard.jpg)", "backgroundSize": "auto 100%", "backgroundPosition": "center", "backgroundRepeat": "no-repeat"}}, [__jacJsx(DashboardHeader, {}, []), __jacJsx("div", {"className": "flex flex-col lg:flex-row gap-6 max-w-7xl mx-auto"}, [__jacJsx(DashboardSidebar, {"user_email": user_email, "target_role": target_role, "skills": skills, "missing_skills": missing_skills_list}, []), __jacJsx("main", {"className": "flex-1 space-y-6"}, [__jacJsx(DashboardWelcome, {"user_email": user_email}, []), __jacJsx(DashboardMetrics, {"matched_skills_count": matched_skills_count, "missing_skills_count": missing_skills_count, "role_fit_percent": role_fit_percent}, []), __jacJsx(LearningRoadmap, {"learning_path": learning_path, "target_role": target_role}, []), __jacJsx(JobOpportunities, {"job_postings": job_postings}, [])]), __jacJsx(RightPanel, {"resume_summary": resume_summary, "target_role": target_role, "role_description": role_description}, [])])]);
}
